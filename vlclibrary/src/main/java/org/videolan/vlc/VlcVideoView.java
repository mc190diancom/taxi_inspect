...
public class VlcVideoView extends TextureView implements MediaPlayerControl, VideoSizeChange {
    ...
    public startPlayListner playListner;
    public void setCallBack(startPlayListner playListner) {
        this.playListner = playListner;
    }

    public interface startPlayListner{
        void startPlay(int CurrentPosition);
    }

    @Override
    public int getCurrentPosition() {
        playListner.startPlay(videoMediaLogic.getCurrentPosition());
...
//    }
    ...
    private SurfaceTextureListener videoSurfaceListener = new SurfaceTextureListener() {
        @Override
