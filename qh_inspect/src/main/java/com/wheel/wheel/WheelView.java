...
package com.wheel.wheel;

import java.util.LinkedList;
import java.util.List;

import com.wheel.wheel.adapter.WheelViewAdapter;
...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	private int[] SHADOWS_COLORS = new int[] { 0x88E9E9E9,
			0x88E9E9E9, 0x3fE9E9E9 };
...
//		setBackgroundResource(wheelBackground);
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(0xff418ff8);
		// 璁剧疆绾垮
		paint.setStrokeWidth((float) 3);
		// 缁樺埗涓婅竟鐩寸嚎
		canvas.drawLine(10, center - offset, getWidth()-20, center - offset, paint);
		// 缁樺埗涓嬭竟鐩寸嚎
		canvas.drawLine(10, center + offset, getWidth()-20, center + offset, paint);
		//*/
	}
