...
import com.miu360.taxi_check.adapter.GoodsDangerousTrasportCarAdapter;
...
public class GoodsDangerousTrasportCarInfoActivity extends BaseActivity implements OnItemClickListener, OnRefreshListener2<ListView> {

	ListViewHolder holder;
	ArrayList<HuoYunInfo> arrayList = new ArrayList<HuoYunInfo>();
	GoodsDangerousTrasportCarAdapter adapter;
	HeaderHolder header;
	...
	private void initView() {
		...
		adapter = new GoodsDangerousTrasportCarAdapter(self, arrayList);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		Intent intent = new Intent(self, DangerousGoodsTrasportCarDetailInfoActivity.class);
