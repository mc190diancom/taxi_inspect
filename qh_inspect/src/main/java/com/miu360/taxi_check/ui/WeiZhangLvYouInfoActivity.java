...
public class WeiZhangLvYouInfoActivity extends BaseActivity implements OnClickListener {
	...
	private void initData(LvYouWeiFaInfo weifa) {
	...
	private void initView() {
		...
		weifa = (LvYouWeiFaInfo) intent.getSerializableExtra("LvYouWeiFaInfo");
