...
public class ShengJiPeopleInfoActivity extends BaseActivity implements OnClickListener {
	...
	private TextView type_chongye;// 从业资格类别
	@ViewInject(R.id.birthday_people)
	private TextView birthday_people;// 生日
	@ViewInject(R.id.first_time)
	private TextView first_time;// 首次领证时间
	@ViewInject(R.id.start_time)
	private TextView start_time;// 有效开始时间
	@ViewInject(R.id.end_time)
	private TextView end_time;// 有效结束时间
	@ViewInject(R.id.status_chongye)
	private TextView status_chongye;// 有

	ShengJiPeopleInfo vehicleInfo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shengji_people_info);
	...
	private void initView() {
		...
		vehicleInfo = (ShengJiPeopleInfo) intent.getSerializableExtra("ShengJiPeopleInfo");
		initData(vehicleInfo);
	}

	private void initData(final ShengJiPeopleInfo info) {
