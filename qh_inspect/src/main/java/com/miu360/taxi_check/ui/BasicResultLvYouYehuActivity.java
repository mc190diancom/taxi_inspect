...
import com.miu360.taxi_check.adapter.TouristYehuInfoAdapter;
...
public class BasicResultLvYouYehuActivity extends BaseActivity
		implements OnItemClickListener, OnRefreshListener2<ListView> {

	ListViewHolder holder;
	ArrayList<LvyouYehuInfo> arrayList = new ArrayList<LvyouYehuInfo>();
	TouristYehuInfoAdapter adapter;
	...
	private void initView() {
		...
		adapter = new TouristYehuInfoAdapter(self, arrayList);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		Intent intent = new Intent(self, BasicShengjiCompanyInfoActivity.class);
		intent.putExtra("LvyouYehuInfo", (LvyouYehuInfo) arg0.getItemAtPosition(arg2));
