...
public class WeiZhangQueryHuoYunAdapter extends BaseAdapter {
	ArrayList<HuoYunWeiFaInfo> list;
	Context ctx;
	public LayoutInflater mInflater;
	private final String datePatterShow = "yyyy-MM-dd HH:mm";
	private final String datePatter = "yyyyMMddHHmm";

	public WeiZhangQueryHuoYunAdapter(Context ctx, ArrayList<HuoYunWeiFaInfo> list) {
		this.list = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			holder = (ViewHolder3) arg1.getTag();
		}
