...
public class WeiZhangQueryZuLinAdapter extends BaseAdapter {
	ArrayList<ZuLinWeiFaInfo> list;
	Context ctx;
	public LayoutInflater mInflater;
	private final String datePatterShow = "yyyy-MM-dd HH:mm";
	private final String datePatter = "yyyyMMddHHmm";

	public WeiZhangQueryZuLinAdapter(Context ctx, ArrayList<ZuLinWeiFaInfo> list) {
		this.list = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			arg1 = (ViewGroup) mInflater.inflate(R.layout.queryzulinresultinfo, arg2, false);
			...
			holder = (ViewHolder4) arg1.getTag();
		}
