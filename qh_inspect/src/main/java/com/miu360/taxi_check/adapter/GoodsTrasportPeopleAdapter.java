...
public class GoodsTrasportPeopleAdapter extends BaseAdapter {
	ArrayList<HuoYunPeopleInfo> list;
	LayoutInflater mInflater;

	public GoodsTrasportPeopleAdapter(Context ctx, ArrayList<HuoYunPeopleInfo> list) {
		this.list = list;
	...
	class Holder {
		...
		public TextView id_card_number;
		public TextView zige_number;
