...
public class WeiZhangQueryLvYouAdapter extends BaseAdapter {
	ArrayList<LvYouWeiFaInfo> list;
	Context ctx;
	public LayoutInflater mInflater;
	private final String datePatterShow = "yyyy-MM-dd HH:mm";
	private final String datePatter = "yyyyMMddHHmm";

	public WeiZhangQueryLvYouAdapter(Context ctx, ArrayList<LvYouWeiFaInfo> list) {
		this.list = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			holder = (ViewHolderLvYou) arg1.getTag();
		}
