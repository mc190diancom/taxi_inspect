...
public class WeiZhangQueryShuiYunAndWeiXiuAdapter  extends BaseAdapter {
	ArrayList<WaterTranspt> list;
	Context ctx;
	public LayoutInflater mInflater;
	private final String datePatterShow = "yyyy-MM-dd HH:mm";
	private final String datePatter = "yyyyMMddHHmm";

	public WeiZhangQueryShuiYunAndWeiXiuAdapter(Context ctx, ArrayList<WaterTranspt> list) {
		this.list = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		holder.number_car.setText(list.get(arg0).getDWMC());
