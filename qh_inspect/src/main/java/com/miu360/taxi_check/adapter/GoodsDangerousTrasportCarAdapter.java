...
public class GoodsDangerousTrasportCarAdapter extends BaseAdapter {
	ArrayList<HuoYunInfo> list;
	LayoutInflater mInflater;

	public GoodsDangerousTrasportCarAdapter(Context ctx, ArrayList<HuoYunInfo> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.basicresulthuoyuncaradapter2, parent, false);
