...
public class ShengJiPeopleAdapter extends BaseAdapter {
	ArrayList<ShengJiPeopleInfo> list;
	LayoutInflater mInflater;

	public ShengJiPeopleAdapter(Context ctx, ArrayList<ShengJiPeopleInfo> list) {
		this.list = list;
