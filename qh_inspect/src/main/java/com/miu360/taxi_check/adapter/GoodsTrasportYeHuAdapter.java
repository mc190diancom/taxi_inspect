...
public class GoodsTrasportYeHuAdapter extends BaseAdapter {
	ArrayList<HuoYunYeHuInfo> list;
	LayoutInflater mInflater;

	public GoodsTrasportYeHuAdapter(Context ctx, ArrayList<HuoYunYeHuInfo> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.basicresultcompanyadapter, parent, false);
