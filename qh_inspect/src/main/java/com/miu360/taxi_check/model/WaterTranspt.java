...
public class WaterTranspt implements Serializable{
   private String JCBH;
   ...
   private String YCHDSJ;
   
   private String CFDX;
   
   private String WFXZBH;
	...
	public String getYCHDSJ() {
		return YCHDSJ;
	}
	
	public void setYCHDSJ(String yCHDSJ) {
		YCHDSJ = yCHDSJ;
	}
	...
	public String getWFXZBH() {
		return WFXZBH;
	}
	
	public void setWFXZBH(String wFXZBH) {
		WFXZBH = wFXZBH;
	}
	
	@Override
	public String toString() {
		return "WaterTranspt [JCBH=" + JCBH + ", JCSJ=" + JCSJ + ", RBRQ=" + RBRQ
				+ ", AJLY=" + AJLY + ", ZFDDMC=" + ZFDDMC + ", JCR1=" + JCR1
				+ ", JCR2=" + JCR2 + ", HYLB=" + HYLB + ", DSR=" + DSR + ", SFZH="
				+ SFZH + ", ZJZH=" + ZJZH + ", CLPH=" + CLPH + ", YS=" + YS
				+ ", CX=" + CX + ", JCDD=" + JCDD + ", SSQX=" + SSQX + ", DWMC="
				+ DWMC + ", DDBH=" + DDBH + ", AJZT=" + AJZT + ", DLYSZH=" + DLYSZH
				+ ", WZSY=" + WZSY + ", DWBH=" + DWBH + ", JASJ=" + JASJ
				+ ", XWBM=" + XWBM + ", YCHDSJ=" + YCHDSJ + ", CFDX=" + CFDX
				+ ", WFXZBH=" + WFXZBH + "]";
	}
