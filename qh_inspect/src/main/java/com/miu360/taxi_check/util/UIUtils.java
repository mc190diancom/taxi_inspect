...
public class UIUtils {
	...
	public static String showTime(int time, String htmlColor) {

		return "预计<font color='" + htmlColor + "'>" + time + "</font>分钟到";
	}

	public static void moreShare(Activity act, String text) {
		try {
			String appName = act.getString(R.string.app_name);
			ShareCompat.IntentBuilder.from(act).setSubject(appName).setText(appName + "\r\n" + text)
	...
	public static boolean copy(String val) {
		...
		try {
			...
			if (sdk < android.os.Build.VERSION_CODES.HONEYCOMB) {
				android.text.ClipboardManager clipboard = (android.text.ClipboardManager) App.self
						.getSystemService(Context.CLIPBOARD_SERVICE);
				clipboard.setText(val);
			} else {
				android.content.ClipboardManager clipboard = (android.content.ClipboardManager) App.self
						.getSystemService(Context.CLIPBOARD_SERVICE);
