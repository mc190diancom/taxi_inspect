...
import com.miu360.taxi_check.zxing.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
	...
	public void quitSynchronously() {
		...
		removeMessages(DecodeHandler.SUC);
		removeMessages(DecodeHandler.FAIL);
	}
