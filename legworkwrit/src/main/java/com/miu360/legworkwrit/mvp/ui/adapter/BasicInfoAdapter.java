...
public class BasicInfoAdapter extends BaseAdapter {
    private ArrayList<DriverInfo> list_driverName;
    private Context mContext;

    public BasicInfoAdapter(ArrayList<DriverInfo> list_driverName,Context mContext){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder_driver.info.setText(list_driverName.get(position).getDriverName());
        return view;
    }
