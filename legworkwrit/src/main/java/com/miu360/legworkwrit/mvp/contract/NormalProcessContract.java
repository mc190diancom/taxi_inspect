...
public interface NormalProcessContract {
    ...
    interface Model extends IModel {
        Observable<Result<List<BlType>>> getBlType(String type);
        ...
        Observable<Result<ArrayList<BlType>>> getCurrentBlType(Map<String, Object> map);
    }
}
